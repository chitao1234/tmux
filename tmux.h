...
#define TTY_CLOSEPENDING 0x8000
...
int		 path_is_drive_relative(const char *);
...
char		*path_basename_copy(const char *);
...
int	tty_close_graceful(struct tty *);
...
#ifdef TMUX_WIN32
int	 input_key_job(struct screen *, struct job *, key_code);
#endif
...
/* utf8.c */
enum utf8_state	 utf8_touc(const struct utf8_data *, u_int *);
enum utf8_state	 utf8_fromuc(u_int, struct utf8_data *);
